...
public class ZipfDistributionValidator implements MapFunction<Tuple2<String, Integer>, Tuple2<String, Integer>> {
    ...
    @Override
    public Tuple2<String, Integer> map(Tuple2<String, Integer> entry) {
        counter++;
